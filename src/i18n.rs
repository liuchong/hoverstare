...
impl T {
    ...
    pub fn permission_denied(&self) -> &'static str {
        match self.0 {
            ...
            Lang::Fr => "Permission refusée : vous ne remplissez pas les conditions pour cette commande.",
            Lang::De => "Berechtigung verweigert: Sie erfüllen nicht die Anforderungen für diesen Befehl.",
